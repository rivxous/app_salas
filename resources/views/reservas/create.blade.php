...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <div class="container-fluid shadow-lg bg-white p-3 rounded-3" id="calentadario" >
                    <h2>
    ...
    <script>
        $(document).ready(function () {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                locale: 'es',
                timeZone: 'America/Caracas', // Asegura que FullCalendar muestre en esta zona
                firstDay: 1,
                navLinks: true,
                nowIndicator: true,
                eventTimeFormat: {
                ...
                dateClick: function (info) {
                    ...
                    HoraInicio = $('[name="horas_inicio\\[\\]"]').value();
...
console.log(info.event.start);
        ...
        <div class="popover-content-custom">
            ...
            fk_idSala.addEventListener('change', async (e) => {
                try {
                    const res = await fetch("{{ route('buscar_salas_horarios_disponibles') }}", {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('input[name="_token"]').value
                        },
                        body: JSON.stringify({id_sala: e.target.value})
                    });
                    ...
                    const events = reservas.flatMap(reserva => {
                        return reserva.reserva_horarios.map(horario => {
                            const fechaBase = new Date(horario.fecha);
                            ...
                            // Crear fechas en UTC-4 (Caracas)
                            const startDate = new Date(
                                fechaBase.getTime() +
                                (startH * 3600 * 1000) +
                                (startM * 60 * 1000) -
                                (4 * 3600 * 1000) // Offset UTC-4
                            );
                            ...
                            return {
                                ...
                                extendedProps: {
                                    ...
                                    // Nuevo campo para participantes
